...
See `skills/critic/academic-paper-reviewer/SKILL.md` for review process details.
...
See `skills/critic/academic-paper-reviewer/SKILL.md` Re-Review Mode for verification review process.
