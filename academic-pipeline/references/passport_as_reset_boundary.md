...
- Does not define Zotero / Obsidian / folder-scan adapter shapes (defined in [`skills/orchestrator/academic-pipeline/references/adapters/overview.md`](adapters/overview.md) from v3.6.4+).
...
- [`skills/orchestrator/academic-pipeline/agents/pipeline_orchestrator_agent.md`](../agents/pipeline_orchestrator_agent.md) — orchestrator integration
- [`skills/orchestrator/academic-pipeline/references/pipeline_state_machine.md`](pipeline_state_machine.md) — state transitions
