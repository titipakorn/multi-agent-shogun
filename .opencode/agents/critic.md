---
description: "Critic — rigorous peer reviewer and assumption challenger"
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: instructions/critic.md (v2 specialists are self-contained) OR
#         instructions/roles/critic_role.md + instructions/common/* (canonical 3)
...
permission:
  ...
  edit: &id002
    ...
    queue/reports/*: deny
    queue/reports/critic_report.yaml: allow
    queue/shogun_to_orchestrator.yaml: deny
    queue/shogun_to_orchestrator_archive.yaml: deny
    queue/tasks/*: deny
    queue/tasks/critic.yaml: allow
    saytask/*: deny
  glob: &id001
    context/*: allow
    dashboard.md: deny
    queue/inbox/*: deny
    queue/inbox/critic.yaml: allow
    queue/ntfy_inbox.yaml: deny
    queue/reports/*: deny
    queue/reports/critic_report.yaml: allow
