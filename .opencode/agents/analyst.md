---
description: "Analyst — result interpreter (reads numbers against hypotheses)"
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: instructions/analyst.md (v2 specialists are self-contained) OR
#         instructions/roles/analyst_role.md + instructions/common/* (canonical 3)
...
permission:
  ...
  edit: &id002
    ...
    queue/reports/*: deny
    queue/reports/analyst_report.yaml: allow
    queue/shogun_to_orchestrator.yaml: deny
    queue/shogun_to_orchestrator_archive.yaml: deny
    queue/tasks/*: deny
    queue/tasks/analyst.yaml: allow
    saytask/*: deny
  glob: &id001
    context/*: allow
    dashboard.md: deny
    queue/inbox/*: deny
    queue/inbox/analyst.yaml: allow
    queue/ntfy_inbox.yaml: deny
    queue/reports/*: deny
    queue/reports/analyst_report.yaml: allow
