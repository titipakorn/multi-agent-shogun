---
description: "Ablation Planner — systematic attribution specialist (isolates components)"
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: instructions/ablation_planner.md (v2 specialists are self-contained) OR
#         instructions/roles/ablation_planner_role.md + instructions/common/* (canonical 3)
...
permission:
  ...
  edit: &id002
    ...
    queue/reports/*: deny
    queue/reports/ablation_planner_report.yaml: allow
    queue/shogun_to_orchestrator.yaml: deny
    queue/shogun_to_orchestrator_archive.yaml: deny
    queue/tasks/*: deny
    queue/tasks/ablation_planner.yaml: allow
    saytask/*: deny
  glob: &id001
    context/*: allow
    dashboard.md: deny
    queue/inbox/*: deny
    queue/inbox/ablation_planner.yaml: allow
    queue/ntfy_inbox.yaml: deny
    queue/reports/*: deny
    queue/reports/ablation_planner_report.yaml: allow
...
- Canonical agent_id: `ablation_planner`
