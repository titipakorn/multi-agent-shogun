---
description: "Telegram — handling side queries and utility commands"
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: instructions/telegram.md (v2 specialists are self-contained) OR
#         instructions/roles/telegram_role.md + instructions/common/* (canonical 3)
...
permission:
  ...
  glob: &id001
    ...
    dashboard.md: allow
    queue/inbox/*: deny
    queue/inbox/telegram.yaml: allow
